...
def sample_test(model_rnn, codes, chunk_len, seqlen):
...
def generate_audio(model_rnn):
    fs, ld, z = generate_rnn(model_rnn)
...
def generate_sample_test(model_rnn, code, chunk_len=1, seqlen=1):
    fs, ld, z = sample_test(model_rnn, code, chunk_len, seqlen)
    fh = f0_scaleds_to_f0_hzs(fs)
